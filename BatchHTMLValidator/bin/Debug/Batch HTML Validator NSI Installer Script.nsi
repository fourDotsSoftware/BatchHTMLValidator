...
;copy translations end
  ...
  !define MUI_FILE "BatchHTMLValidator"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Batch HTML Validator"
  !define PRODUCT_SHORTCUT "Batch HTML Validator"
  !define MUI_ICON "earth_preferences.ico"
  !define PRODUCT_VERSION "1.6"
 ; !define LIBRARY_SHELL_EXTENSION

!define PRODUCT_PUBLISHER "4dots Software"
!define PRODUCT_NAME "Batch HTML Validator"
!define PRODUCT_WEB_SITE "http://www.4dots-software.com"
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
 ...
 !include nsDialogs.nsh
  ...
  Name "Batch HTML Validator"
  OutFile "BatchHTMLValidatorSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\BatchHTMLValidator" ""
...
CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Batch HTML Validator - Users Manual.url.lnk" "$INSTDIR\Batch HTML Validator - Users Manual.url" "" "$INSTDIR\Batch HTML Validator - Users Manual.url" 0
...
;Add files
  ...
  ;inetc::get /SILENT "http://www.4dots-software.com/installmonetizer/quickfilelocker.php" "$PLUGINSDIR\Installmanager.exe" /end
 ...
 Call IsDotNetInstalledAdv
  ...
  File "Batch HTML Validator - User's Manual.url"
 ...
 ; File "C:\4dots Software Offline\4dots Software Product CATALOG.url"
  File "C:\code\Misc\=Licenses\NuHtmlChecker_license.txt"
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\${PRODUCT_SHORTCUT}" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\${PRODUCT_SHORTCUT}" "InstallationDirectory" $INSTDIR
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\BatchHTMLValidator"
  DeleteRegKey HKCU "Software\4dots Software\BatchHTMLValidator"
...
Function .onInstSuccess
 MessageBox MB_OK "You have successfully installed ${MUI_PRODUCT}. Use the desktop icon to start the program."
   ...
   ExecShell "" "http://www.4dots-software.com/batch-html-validator/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
FunctionEnd
